...
class RearViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tttableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! RearTableViewCell
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tttableView.register(UINib(nibName: "cell", bundle: nil), forCellReuseIdentifier: "cell")
